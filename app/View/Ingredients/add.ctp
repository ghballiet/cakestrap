...
<div class="row">
  ...
  <div class="span9">
<?= $this->Form->create('Ingredient') ?><?= $this->Form->input('name', array('autofocus'=>'true')); ?><?= $this->Form->input('description') ?><?= $this->Form->input('Recipe') ?><?= $this->Form->end(__('Submit')) ?>    
  </div>
</div>